<div>
    ...
    <div class="mx-auto max-w-6xl py-8">
        ...
        <div class="glass card-shadow mb-6 flex flex-col gap-4 rounded-[2rem] px-6 py-7 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="mt-3 text-sm leading-7 text-soft">Keep your favorite items in one place and send them to the cart when you are ready.</p>
            </div>
        ...
        @else
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
                    ...
                    <div class="surface card-shadow group flex flex-col overflow-hidden rounded-[1.75rem] transition-all hover:-translate-y-1">
