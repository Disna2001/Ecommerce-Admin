                                    ...
                                    @forelse($orders->take(4) as $order)
                                        <div class="flex flex-col gap-3 rounded-2xl border border-slate-200 p-4 dark:border-slate-700 sm:flex-row sm:items-center sm:justify-between">
                                            ...
                                            <div class="flex flex-wrap items-center gap-2">
                                                ...
                                                <a wire:navigate href="{{ route('orders.show', $order) }}" class="rounded-full bg-violet-50 px-4 py-2 text-xs font-black text-violet-700 dark:bg-violet-500/10 dark:text-violet-200">View details</a>
                                            </div>
                                        </div>
                                    @empty
                            ...
                            <div class="{{ $panel }}">
                                <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                                    ...
                                    <div class="flex flex-wrap items-center gap-2">
                                        ...
                                        <span class="text-sm font-black text-slate-950 dark:text-white">Rs {{ number_format($order->total ?? 0, 2) }}</span>
                                        <a wire:navigate href="{{ route('orders.show', $order) }}" class="rounded-full bg-violet-600 px-4 py-2 text-xs font-black text-white">View details</a>
                                    </div>
                                </div>
                            </div>
                        @empty
