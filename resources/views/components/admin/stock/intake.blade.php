    ...
    <div class="relative z-10">
        <div class="flex items-center gap-6 mb-12">
            ...
            <div>
                ...
                <h3 class="text-3xl font-black tracking-tight text-slate-900">Inventory Intake Desk</h3>
        ...
        <div class="grid gap-8 md:grid-cols-2">
            <!-- Quick Intake Card -->
            <button type="button" wire:click="startQuickIntake" class="group relative flex flex-col gap-8 rounded-[2.5rem] border border-slate-100 bg-slate-50/50 p-10 text-left transition-all hover:bg-white hover:border-slate-900 hover:shadow-2xl hover:shadow-slate-200 hover:-translate-y-2">
            ...
            <button type="button" wire:click="startAdvancedIntake" class="group relative flex flex-col gap-8 rounded-[2.5rem] border border-slate-100 bg-slate-50/50 p-10 text-left transition-all hover:bg-white hover:border-indigo-600 hover:shadow-2xl hover:shadow-indigo-100 hover:-translate-y-2">
        ...
        <div class="mt-16 pt-16 border-t border-slate-100">
            ...
            <div class="relative group">
                ...
                <input type="text" wire:model.defer="scanCode" wire:keydown.enter.prevent="processScan" 
                    placeholder="Scan barcode to instantly identify existing records or initialize new intake protocol..." 
                    class="w-full rounded-[2rem] border-slate-100 bg-slate-50/80 pl-16 pr-40 py-6 text-sm font-bold shadow-inner focus:bg-white focus:border-slate-900 focus:ring-0 transition-all">
                <button type="button" wire:click="processScan" class="absolute right-3 top-1/2 -translate-y-1/2 rounded-2xl bg-slate-900 px-10 py-3.5 text-[10px] font-black text-white uppercase tracking-[0.2em] shadow-2xl shadow-slate-200 transition-all hover:scale-[1.02] active:scale-[0.98]">
                    Scan & Initialize
                </button>
            </div>
